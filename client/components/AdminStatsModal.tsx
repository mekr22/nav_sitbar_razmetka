      ...
      <DialogContent className="max-w-2xl max-h-[90vh] bg-[#0C1014] border-[#181B22] overflow-y-auto">
        ...
        <DialogFooter className="gap-2">
          <button
            ...
            className="px-4 py-2 text-sm font-semibold text-[#B0B0B0] border border-[#181B22] rounded-full hover:border-[#1F2230] hover:text-white transition-colors"
            disabled={loading}
          >
            Cancel
          </button>
          <button
            onClick={handleSave}
            className="px-4 py-2 text-sm font-semibold text-white bg-[#A06AFF] rounded-full hover:opacity-90 transition-opacity disabled:opacity-50"
            disabled={loading}
          >
            {loading ? 'Saving...' : 'Save'}
          </button>
