  ...
  <div className="mx-auto w-full max-w-[525px]">
    ...
    >
      ...
      <div className="relative p-5 sm:p-6">
        ...
        <div className="mt-5 grid gap-3 text-sm font-semibold text-white sm:grid-cols-2 sm:gap-4">
          <div className="rounded-xl border border-[#181B22] bg-[#0F141A]/80 px-4 py-3">
            <div className="text-xs font-bold uppercase tracking-wide text-[#B0B0B0]">Number of Clients</div>
            <div className="text-lg font-bold text-white">{consultant.clients}</div>
          </div>
          <div className="rounded-xl border border-[#181B22] bg-[#0F141A]/80 px-4 py-3">
            <div className="text-xs font-bold uppercase tracking-wide text-[#B0B0B0]">Risk Level</div>
            <div className="text-lg font-bold text-white">{consultant.riskLevel}</div>
          </div>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-3 rounded-2xl border border-[#181B22] bg-[#0B0F13]/80 px-5 py-4 text-sm font-semibold text-[#B0B0B0]">
