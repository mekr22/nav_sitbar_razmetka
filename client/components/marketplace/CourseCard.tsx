      ...
      >
        <div
          className={cn(
            ...
            isCompact ? "h-40" : "md:w-[231px] md:self-center",
          )}
        >
          <img
            src={course.image}
            ...
            className={cn(
              "w-full object-cover",
              isCompact ? "h-full" : "h-[133px] md:h-auto",
            )}
          />
        </div>
        ...
        <div
          className={cn(
            "flex flex-1 flex-col gap-4 md:gap-3",
            isCompact ? "h-full justify-between" : "md:justify-between",
          )}
        >
          <div className="flex items-start gap-4 pr-6 md:pr-8">
            <div className="flex flex-col gap-1">
              <h3
                className={cn(
                  "text-lg font-bold text-white sm:text-[19px]",
              ...
              <p
                className={cn(
                  "text-sm font-bold text-[#B0B0B0] sm:text-[15px]",
                  isCompact && "line-clamp-2",
                )}
              >
                {course.subtitle}
          ...
          <div
            className={cn(
              "flex flex-col gap-2 sm:flex-row sm:self-end sm:items-center sm:gap-3 md:ml-auto",
              isCompact ? "mt-auto" : "mt-2 sm:mt-0",
            )}
          >
            <button
              className={cn(
