      ...
      <div className="flex w-full flex-col gap-6">
          ...
          >
            <g clipPath="url(#clip0_footer)">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M0 16.4905L0.0012947 16.5883C3.08952 15.955 6.19422 15.2936 9.30464 14.6309L9.31038 30.3517L19.7747 32.5C19.7747 29.0478 19.7423 19.3225 19.7765 15.8712L12.4543 14.3681L11.4797 14.1682C16.955 13.0046 22.4401 11.8564 27.876 10.8678L27.8742 0.5C18.6809 2.38675 9.22271 4.61696 0 6.22091L0 16.4905Z"
        ...
        <div className="flex flex-col gap-12 xl:flex-col xl:gap-10 min-[1601px]:grid min-[1601px]:grid-cols-[minmax(0,1.25fr)_minmax(0,1fr)_minmax(0,0.75fr)] min-[1601px]:items-start min-[1601px]:gap-x-10 min-[1601px]:gap-y-12 min-[1888px]:flex min-[1888px]:flex-row min-[1888px]:gap-12">
          ...
          <div className="flex w-full flex-col gap-2.5 xl:order-1 xl:w-full min-[1601px]:order-1 min-[1601px]:w-full min-[1601px]:col-start-1 min-[1601px]:col-end-2 min-[1888px]:flex-1 min-[1888px]:gap-5">
            <h4 className="text-lg font-bold text-[#A06AFF] sm:text-[19px]">
              Products
            </h4>
            <div className="grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xl:gap-x-8 xl:gap-y-4 min-[1601px]:grid-cols-2 min-[1601px]:gap-x-12 min-[1601px]:gap-y-6 min-[1888px]:grid-cols-4 min-[1888px]:gap-0">
              <a
                href="#"
                className="flex items-center gap-2.5 rounded py-2 text-sm font-bold text-white transition-colors hover:text-[#A06AFF] sm:text-[15px]"
              >
          ...
          <div className="flex w-full flex-col gap-5 xl:order-3 xl:w-full xl:max-w-none min-[1601px]:order-3 min-[1601px]:w-full min-[1601px]:col-start-3 min-[1601px]:col-end-4 min-[1888px]:w-[120px] min-[1888px]:flex-shrink-0">
            ...
            <a
              href="#"
              className="text-sm font-bold text-white transition-colors hover:text-[#A06AFF] sm:text-[15px]"
            >
              AI
            </a>
          </div>
          ...
          <div className="flex w-full flex-col gap-2.5 xl:order-2 xl:w-full xl:max-w-none min-[1601px]:order-2 min-[1601px]:w-full min-[1601px]:col-start-2 min-[1601px]:col-end-3 min-[1888px]:w-[120px] min-[1888px]:flex-shrink-0 min-[1888px]:gap-5">
            <h4 className="text-lg font-bold text-[#A06AFF] sm:text-[19px] min-[1601px]:pl-9 min-[1888px]:pl-0">
              Social
            </h4>
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 min-[1601px]:flex-col min-[1601px]:items-start min-[1601px]:gap-2 min-[1888px]:flex min-[1888px]:flex-col min-[1888px]:gap-2">
              <a
                href="#"
                className="flex items-center gap-2.5 rounded text-sm font-bold text-white transition-colors hover:text-[#A06AFF] sm:text-[15px] min-[1888px]:gap-2.5 min-[1888px]:py-0"
              >
                <span
                  className="hidden h-6 w-6 min-[1601px]:block min-[1888px]:hidden"
                  aria-hidden="true"
                ></span>
                <span>X/Twitter</span>
              </a>
        ...
        <div className="flex items-start justify-start">
          <p className="text-left text-sm font-normal leading-normal text-[#B0B0B0] sm:text-[15px]">
            Trading cryptocurrencies and financial instruments involves high
            risk and may result in losses exceeding your initial investment. All
            content on this website is for informational and educational
            purposes only and does not constitute financial advice. Prices and
            data may be inaccurate or delayed. TTYRIAN TRADE and its partners
            are not liable for any losses from using this website. Always do
            your own research and consult a professional if needed. Past
            performance is not a guarantee of future results. Trading on margin
            increases risk. Use of site content is prohibited without prior
            written consent. TTYRIAN TRADE may receive compensation from
            advertisers.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <a
              href="#"
              className="hidden min-[1656px]:inline text-sm font-bold text-[#B0B0B0] transition-colors hover:text-white sm:text-[15px]"
            >
              House Rules
            </a>
