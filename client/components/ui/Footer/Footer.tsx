    ...
    <footer className="mx-[38px] rounded-t-[48px] border-t-2 border-r-2 border-l-2 border-[#181B22] bg-[#0C101480] px-6 pb-12 pt-12 backdrop-blur-[32px] sm:px-12 lg:px-[310px] lg:pt-12">
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="flex flex-col gap-12 xl:flex-col xl:gap-10 2xl:flex-row 2xl:flex-nowrap 2xl:gap-12">
          ...
          {/* Resources Section */}
          <div className="flex w-full flex-col gap-5 xl:order-3 xl:w-full xl:max-w-none 2xl:flex-1 2xl:min-w-[240px] 2xl:max-w-[320px]">
          ...
          {/* Social Section */}
          <div className="flex w-full flex-col gap-5 xl:order-2 xl:w-full xl:max-w-none 2xl:flex-1 2xl:min-w-[240px] 2xl:max-w-[320px]">
