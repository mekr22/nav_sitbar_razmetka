    ...
    <footer className="mx-[38px] rounded-t-[48px] border-t-2 border-r-2 border-l-2 border-[#181B22] bg-[#0C101480] px-6 pb-12 pt-12 backdrop-blur-[32px] sm:px-12 lg:px-[310px] lg:pt-12">
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="flex flex-col gap-12 xl:flex-col xl:gap-10 min-[1601px]:flex-row min-[1601px]:flex-wrap min-[1601px]:justify-between min-[1601px]:gap-12 min-[1888px]:flex-nowrap min-[1888px]:gap-12">
          ...
          {/* Resources Section */}
          <div className="flex w-full flex-col gap-5 xl:order-3 xl:w-full xl:max-w-none min-[1601px]:order-3 min-[1601px]:w-auto min-[1601px]:flex-[0.8] min-[1888px]:order-2 min-[1888px]:flex-1 min-[1888px]:min-w-[240px] min-[1888px]:max-w-[320px]">
          ...
          {/* Social Section */}
          <div className="flex w-full flex-col gap-2.5 xl:order-2 xl:w-full xl:max-w-none min-[1601px]:order-2 min-[1601px]:w-auto min-[1601px]:flex-[0.8] min-[1888px]:order-3 min-[1888px]:flex-1 min-[1888px]:min-w-[240px] min-[1888px]:max-w-[320px]">
