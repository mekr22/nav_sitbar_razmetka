  ...
  return (
    <footer className="mx-[38px] rounded-t-[48px] border-t-2 border-r-2 border-l-2 border-[#181B22] bg-[#0C101480] px-6 pb-12 pt-12 backdrop-blur-[32px] sm:px-12 lg:px-[310px] lg:pt-12">
      <div className="flex w-full flex-col gap-6">
        ...
        {/* Main Content Grid */}
        <div className="flex flex-col gap-12 xl:flex-col xl:gap-10 min-[1601px]:grid min-[1601px]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] min-[1601px]:items-start min-[1601px]:gap-12 min-[1888px]:flex min-[1888px]:flex-nowrap min-[1888px]:gap-12">
          {/* Products Section */}
