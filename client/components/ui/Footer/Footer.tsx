    ...
    <footer className="mx-[38px] rounded-t-[48px] border-t-2 border-r-2 border-l-2 border-[#181B22] bg-[#0C101480] px-6 pb-12 pt-12 backdrop-blur-[32px] sm:px-12 lg:px-[310px] lg:pt-12">
      <div className="flex w-full flex-col gap-6">
        ...
        <div className="flex flex-col gap-12 xl:flex-col xl:gap-10 min-[1601px]:grid min-[1601px]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] min-[1601px]:items-start min-[1601px]:gap-12 min-[1888px]:grid min-[1888px]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] min-[1888px]:gap-12">
          {/* Products Section */}
          <div className="flex w-full flex-col gap-2.5 xl:order-1 xl:w-full min-[1601px]:order-1 min-[1601px]:w-full min-[1888px]:order-1">
          ...
          {/* Social Section */}
          <div className="flex w-full flex-col gap-2.5 xl:order-2 xl:w-full xl:max-w-none min-[1601px]:order-2 min-[1601px]:w-full min-[1888px]:order-2">
            <h4 className="text-lg font-bold text-[#A06AFF] sm:text-[19px] min-[1601px]:pl-9">Social</h4>
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 min-[1601px]:flex-col min-[1601px]:items-start min-[1601px]:gap-2 min-[1888px]:grid min-[1888px]:grid-cols-2 min-[1888px]:gap-x-12 min-[1888px]:gap-y-6">
