...
export const RightPanelLayout2: FC<RightPanelProps> = ({
  stats,
  onEditClick,
}) => {
    ...
    <div className="rounded-3xl border border-[#181B22] bg-[#0C101480] p-4 sm:p-6 lg:col-span-2 space-y-4 min-w-0">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div
            className="flex h-12 w-12 items-center justify-center rounded-xl bg-transparent border-2 border-[#A06AFF] flex-shrink-0 shadow-lg shadow-[#A06AFF]/40 relative overflow-hidden"
            style={{
              transform:
                "perspective(800px) rotateX(8deg) rotateY(-8deg) rotateZ(2deg)",
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0) 50%, rgba(0,0,0,0.2) 100%)",
                pointerEvents: "none",
            ...
            <defs>
              <clipPath id={`${id}-progress-clip`}>
                <rect
                  x="0"
                  y="0"
                  width={(chartWidth * progressPercent) / 100}
                  height={chartHeight}
                />
              </clipPath>
              <clipPath id={`${id}-unfilled-clip`}>
                <rect
                  x={(chartWidth * progressPercent) / 100}
                  y="0"
                  width={chartWidth}
                  height={chartHeight}
                />
        ...
        >
          {[
            ...
            >
              ...
              <p className="text-[10px] text-[#B0B0B0] text-center line-clamp-2">
                {label}
              </p>
            </div>
          ))}
...
export const RightPanelLayout3: FC<RightPanelProps> = ({
  stats,
  onEditClick,
}) => {
    ...
    <div className="rounded-3xl border border-[#181B22] bg-[#0C101480] lg:col-span-2 space-y-5 overflow-hidden">
      ...
      <div className="relative overflow-visible shadow-lg shadow-[#A06AFF]/20">
        <div className="relative h-56 w-full px-6 py-4">
          ...
          >
            ...
            <g clipPath={`url(#${id}-unfilled-clip)`}>
              <path d={areaD} fill="#2A2F3A" opacity="0.4" />
            </g>
      ...
      <div className="px-6 py-2">
        <div className="flex flex-row items-center gap-3 h-10">
          ...
          {/* Next Level */}
          <div className="flex-1 px-3 py-2 rounded-2xl border border-[#181B22] bg-[#0C1014]/50 text-center text-xs flex flex-col justify-center h-full">
            <p className="text-[#B0B0B0] text-[9px] leading-tight">
              Next Level
            </p>
...
export const RightPanelLayout4: FC<RightPanelProps> = ({
  stats,
  onEditClick,
}) => (
  <div className="rounded-3xl border border-[#181B22] bg-[#0C101480] p-4 sm:p-6 lg:col-span-2 space-y-4 h-full">
    <div className="space-y-4 h-full flex flex-col">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-[#A0FF75] font-semibold">
          {stats?.total_xp || 0} XP
        </p>
      </div>
      ...
      <div>
        <h3 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wide mb-3">
          Achievements
        </h3>
...
export const RightPanelLayout5: FC<RightPanelProps> = ({
  stats,
  onEditClick,
}) => {
  const progressPercent = stats?.level_info?.progressPercent || 0;
  ...
  return (
    <div className="rounded-3xl border border-[#181B22] bg-[#0C101480] p-4 sm:p-6 lg:col-span-2 space-y-6">
      ...
      <div className="flex flex-col items-center gap-4 pb-4 border-b border-[#1F2230]">
        ...
        <div className="relative w-32 h-32 flex items-center justify-center">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="text-xs uppercase text-[#A06AFF] font-bold tracking-wider">
              Tier
            </p>
          </div>
        </div>
      ...
      {/* Progress Indicators */}
      <div className="space-y-3 pt-4 border-t border-[#1F2230]">
        <div className="flex items-start gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#181B22] flex-shrink-0">
            <TrendingUp className="h-5 w-5 text-white" />
          </div>
