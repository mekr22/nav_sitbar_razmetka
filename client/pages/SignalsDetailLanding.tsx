...
const SignalsDetailLanding: FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 max-[360px]:gap-4">
      ...
      <div className="mx-auto w-full max-w-[1075px] px-3 sm:px-4 max-[360px]:px-2">
        <div className="flex flex-wrap items-center gap-3 max-[360px]:gap-2 max-[360px]:justify-between">
          <button
            type="button"
            onClick={() => setActiveTab("chart")}
            className={`flex h-[26px] items-center justify-center rounded-full px-4 text-[15px] font-bold transition-colors max-[360px]:h-6 max-[360px]:flex-1 max-[360px]:px-3 max-[360px]:text-sm ${
              activeTab === "chart"
          ...
          <div className="flex flex-col gap-5 rounded-3xl border border-[#181B22] bg-[#0C1014]/50 p-4 backdrop-blur-[50px] lg:flex-[2] lg:min-w-0 max-[360px]:gap-4 max-[360px]:p-3">
            ...
            <div className="relative flex flex-col gap-6 rounded-3xl border border-[#181B22] bg-[#0C1014]/50 p-4 backdrop-blur-[50px] max-[360px]:gap-4 max-[360px]:p-3">
              ...
              <div className="flex flex-col items-end gap-4 max-[360px]:gap-3">
                ...
                <button
                  type="button"
                  className="flex h-[26px] w-[180px] items-center justify-center gap-2.5 rounded-lg bg-gradient-to-l from-[#482090] to-[#A06AFF] px-6 py-2.5 text-[15px] font-bold text-white transition-transform hover:scale-[1.02] max-[360px]:w-auto max-[360px]:px-4 max-[360px]:py-2 max-[360px]:text-sm"
                >
                  Send
                </button>
              </div>
                ...
                {PRODUCT_ACTIONS.map(({ key, label, icon: Icon }) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex w-full items-center justify-center gap-2 rounded-full px-5 py-2 text-xs font-bold uppercase transition-colors ${baseClasses} max-[360px]:gap-1.5 max-[360px]:px-4 max-[360px]:py-2 max-[360px]:text-[11px]`}
                    >
