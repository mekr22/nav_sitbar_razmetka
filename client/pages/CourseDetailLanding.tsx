...
const CourseDetailLanding: FC<{ hideAdditionalContent?: boolean }> = ({
  ...
  const totalReviews = useMemo(
    () => Math.max(Math.round(ratingValue * 22), 24),
    [ratingValue],
  );

  const formatLabel = useMemo(
    () => toTitleCase(course.format),
    [course.format],
  );
  const focusLabel = useMemo(
    () => toTitleCase(course.focusArea),
    [course.focusArea],
  );
    ...
    () => [
      {
        ...
        body: "Clear frameworks and actionable worksheets. The live case breakdowns clarified how to size trades regardless of market regime.",
        rating: 5,
      },
      {
        id: "review-2",
        ...
        body: "The module on risk journaling is worth the price alone. I've already updated my team's playbook with the templates provided.",
        rating: 4,
      },
      {
        id: "review-3",
        ...
        body: "Loved the blend of macro context and tactical entries. Having both recordings and checklists makes it easy to revisit before sessions.",
        rating: 4.5,
      },
    ],
    [],
          ...
          {showFullContent && (
            <>
              <div className="flex flex-col gap-4 rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.50)] p-4 backdrop-blur-[50px]">
                ...
                >
                  <span className="text-[15px] font-medium text-[#A06AFF]">
                    Expand
                  </span>
                  <svg
                    width="24"
            ...
            <div className="flex flex-col gap-4 p-4">
              <div className="flex items-baseline gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="text-[15px] font-medium text-[#B0B0B0] line-through">
                    $39.99
                  </div>
          ...
          <div className="rounded-3xl border border-[#181B22] bg-[rgba(12,16,20,0.50)] backdrop-blur-[50px]">
            <div className="p-4">
              ...
              <div className="mb-4 text-[15px] font-normal text-[#B0B0B0]">
                Students gain lifetime access to annotated slides, case study
                replays, and a private forum moderated weekly by {course.host}.
              </div>
              <div className="mb-4 text-[15px] font-normal text-[#B0B0B0]">
                Weekly AMA sessions keep the cohort aligned with {course.host}'s
                market outlook and provide direct feedback on submitted trade
                plans.
              </div>
              <div className="mb-4 flex items-center gap-3">
