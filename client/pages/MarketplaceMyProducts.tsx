...
const AnalystCard: FC<{ analyst: Analyst }> = ({ analyst }) => (
  <div className="mx-auto w-full max-w-[525px]">
    ...
    >
      ...
      <div className="relative h-[115px] overflow-hidden rounded-xl border border-[#1F1A2D] bg-gradient-to-br from-[#1A1430] via-[#121323] to-[#0B1016]">
      ...
      <div className="flex gap-2">
        <button className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-[#181B22] bg-[#0C1014]/50 px-4 py-2.5 text-xs font-bold text-white backdrop-blur-[50px] transition-colors hover:border-[#1F2230]">
          <BookOpen className="h-4 w-4" />
          Learn More
        </button>
