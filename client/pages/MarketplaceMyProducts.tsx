      ...
      <div className="mx-auto w-full max-w-[880px] px-3 sm:px-4 xl:min-w-[880px]">
        ...
        <div className="flex flex-col gap-8 py-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {/* Trader Card 1 */}
            <div className="relative overflow-hidden rounded-2xl border border-[#A06AFF] bg-[#0C101480] p-4 backdrop-blur-[50px]">
              <div className="flex gap-4">
                <div className="relative h-[120px] w-[120px] flex-shrink-0">
                  <img 
                    src="https://api.builder.io/api/v1/image/assets/TEMP/d83ddcd1551e722a63cd2e617b3a356762dc989a?width=240"
                    alt="Sarah Lee"
                    className="h-full w-full rounded-lg object-cover shadow-lg"
                  />
                  <div className="absolute left-1 top-[96px] flex items-center gap-1">
                ...
                <div className="flex flex-1 flex-col gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-1">
                    <span className="rounded bg-[#3E321D] px-1 text-xs font-bold uppercase text-[#FFA800]">Securities trading (USA)</span>
              ...
              <div className="mt-4 space-y-2">
                <div className="grid grid-cols-2 gap-2 text-xs font-bold">
                  <div className="flex items-center gap-1">
                    <span className="uppercase text-[#B0B0B0]">ROI(Month)</span>
                    <span className="uppercase text-[#2EBD85]">+28.4%</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="uppercase text-[#B0B0B0]">ROI(3 Months)</span>
                    <span className="uppercase text-[#2EBD85]">+28.4%</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="uppercase text-[#B0B0B0]">Average Trade Profitability:</span>
                    <span className="uppercase text-[#2EBD85]">+4.2%</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="uppercase text-[#B0B0B0]">Trades Accuracy</span>
                    <span className="uppercase text-[#2EBD85]">74%</span>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <button className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-[#181B22] bg-[#0C101480] px-4 py-1.5 text-xs font-bold text-white backdrop-blur-[50px] transition-colors hover:border-[#1F2230]">
            ...
            {/* Trader Card 2 */}
            <div className="relative overflow-hidden rounded-2xl border border-[#181B22] bg-[#0C101480] p-4 backdrop-blur-[50px]">
              <div className="flex gap-4">
                <div className="relative h-[120px] w-[120px] flex-shrink-0">
                  <img 
                    src="https://api.builder.io/api/v1/image/assets/TEMP/d83ddcd1551e722a63cd2e617b3a356762dc989a?width=240"
                ...
                <div className="flex flex-1 flex-col gap-2">
                  ...
                  <div className="relative h-14 w-full">
                    <svg className="absolute inset-0 h-full w-full" viewBox="0 0 360 57" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M3.67163 36.9779L1 38.9593V57H359V3.39853L350.317 6.21419L344.306 11.0113L337.627 10.6984L334.287 11.7412L326.272 2.04284L323.601 3.39853L318.925 2.77283L308.907 3.91995L303.563 8.92557L299.556 7.67417C297.997 8.82129 294.881 11.0947 294.881 11.0113C294.881 10.9278 292.209 9.37747 290.873 8.61272L286.866 11.1155L281.522 8.50844L274.843 7.77845L271.504 1L261.485 4.33708H258.145L255.474 5.06707L253.47 3.81566L247.459 9.86413L245.455 8.19559L238.776 7.77845L234.769 9.55128L233.433 5.79706L230.093 7.77845L225.418 5.06707L221.41 6.52705L219.407 5.79706L217.403 6.21419L213.395 2.56426L210.056 10.3855L204.713 7.04846L199.369 6.21419L194.026 11.637L185.343 14.7655L178.664 14.1398L177.996 16.7469L174.657 14.6612L169.313 17.4769L165.306 23.8382L160.631 24.151L155.955 24.5682L153.284 28.6352L149.944 29.1566L141.929 28.6352L131.91 26.341L128.571 29.4695L119.888 30.6166L116.548 30.1995L115.213 31.2423L106.53 29.4695L105.194 30.3038L95.8432 29.7824L87.8283 31.9723L87.1605 33.5366L83.153 33.1194L78.4775 34.6837L75.138 33.5366H67.1231L65.7873 34.058H63.1157L58.4403 35.3094L50.4253 34.2666L46.4179 32.0766L41.7425 32.1809L37.0672 34.6837L33.7276 33.8494L31.7238 34.9965L28.3843 34.2666L17.0298 34.9965L11.6865 37.7079L3.67163 36.9779Z" fill="url(#paint0_linear2)" />
                      <defs>
                        <linearGradient id="paint0_linear2" x1="-152.286" y1="1" x2="-152.286" y2="57" gradientUnits="userSpaceOnUse">
                          <stop stopColor="#A06AFF" stopOpacity="0.32"/>
                          <stop offset="1" stopColor="#181A20" stopOpacity="0"/>
                        </linearGradient>
                      </defs>
