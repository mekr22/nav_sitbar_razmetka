    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="relative size-[86px] flex-shrink-0 overflow-hidden rounded-full shadow-[0_6.711px_11.409px_-1.342px_rgba(0,0,0,0.28)]">
            <img src={analyst.avatar} alt={analyst.name} className="size-full object-cover object-center" />
          </div>
