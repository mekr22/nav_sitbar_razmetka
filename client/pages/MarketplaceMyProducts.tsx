          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3].map((i) => (
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-1 text-[9px] font-semibold text-white sm:text-[10px]">
                  <span className="rounded bg-[#3E321D] px-1.5 py-[2px] text-[8px] font-black uppercase tracking-[0.2em] text-[#FFA800] sm:text-[9px]">
                    Hedge fund manager
                  </span>
                  <span className="rounded bg-[#1C3430] px-1.5 py-[2px] text-[8px] font-black text-[#2EBD85] sm:text-[9px]">5.0</span>
                  <span className="flex items-center gap-1 rounded bg-[#2E2744] px-1.5 py-[2px] text-[8px] font-black sm:text-[9px]">
                ...
                <div className="grid gap-0.5 text-[9px] font-semibold uppercase tracking-[0.12em] text-[#B0B0B0] sm:text-[10px]">
                  <div className="flex items-center gap-1 whitespace-nowrap">
                    <span>Markets:</span>
                ...
                <div className="flex items-center gap-1 text-[9px] font-semibold uppercase tracking-[0.16em] sm:text-[10px]">
                  <span className="text-[#B0B0B0]">Forecast Accuracy:</span>
                  <span className="text-[#2EBD85]">68%</span>
                </div>

                <div className="flex gap-2">
                  <button className="flex flex-1 items-center justify-center gap-1.5 rounded-lg border border-[#1F2230] bg-[#0C1014]/60 px-2.5 py-1.5 text-[9px] font-semibold uppercase tracking-[0.2em] text-white transition-colors hover:border-[#2A2E3F] sm:px-3 sm:py-1.5 sm:text-[10px]">
                    <BookOpen className="h-3 w-3 sm:h-3.5 sm:w-3.5" />
                    Learn More
                  </button>
                  <button className="flex flex-1 items-center justify-center gap-1.5 rounded-lg bg-gradient-to-r from-[#A06AFF] to-[#482090] px-2.5 py-1.5 text-[9px] font-semibold uppercase tracking-[0.2em] text-white transition-opacity hover:opacity-90 sm:px-3 sm:py-1.5 sm:text-[10px]">
