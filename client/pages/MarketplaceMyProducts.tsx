      ...
      <div className="relative p-4">
        ...
        <div className="mb-4 flex items-start justify-between">
          <div className="relative h-24 w-24 flex-shrink-0 overflow-hidden rounded-lg shadow-[0_6.711px_11.409px_-1.342px_rgba(0,0,0,0.28)]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-gradient-to-b from-[#040412]/10 via-[#040412]/45 to-[#040412]/85 px-2 text-center">
              <div className="flex items-center justify-center gap-1 text-white">
                <span className="text-sm font-bold leading-tight sm:text-[17px]">{consultant.name}</span>
                {featured && (
              ...
              {consultant.credentials && (
                <span className="rounded-full border border-white/30 px-2 text-[11px] font-semibold uppercase text-white/90">
                  {consultant.credentials}
                </span>
              )}
            </div>
        ...
        <div className="mb-3 text-xs font-bold uppercase tracking-[0.16em] text-[#B0B0B0]">{consultant.company}</div>
