...
const AnalystCard: FC<{ analyst: Analyst; featured?: boolean }> = ({ analyst, featured }) => (
  <div className="mx-auto w-full max-w-[525px]">
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-xl border border-[#1F1A2D] bg-gradient-to-br from-[#1A1430] via-[#121323] to-[#0B1016]">
        <div className="absolute inset-0 bg-gradient-to-t from-[#A06AFF1A] via-transparent to-transparent" />
        <svg className="relative h-[115px] w-full" viewBox="0 0 312 116" fill="none" xmlns="http://www.w3.org/2000/svg">
