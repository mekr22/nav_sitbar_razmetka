          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-wrap items-center gap-4 sm:gap-6">
                <button
                  type="button"
                  className="flex h-[32px] items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#A06AFF] to-[#482090] px-8 text-[15px] font-bold text-white transition-opacity hover:opacity-90"
                >
                ...
                <button
                  type="button"
                  className="flex h-[32px] items-center justify-center gap-2 rounded-lg border border-[#181B22] bg-[#0C101480] px-3 text-[15px] font-bold text-white backdrop-blur-[50px] transition-colors hover:border-[#1F2230]"
                >
            ...
            {categories.map((category) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "flex h-8 items-center justify-center gap-2 rounded-full px-3 text-sm font-bold text-white backdrop-blur-[58px] transition-colors md:px-4 md:text-[15px]",
                    isSelected
