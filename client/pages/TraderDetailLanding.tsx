        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-6 max-[360px]:gap-4">
          ...
          <div className="flex flex-1 flex-col gap-6 min-w-0 max-[360px]:gap-4">
            ...
            <div className="flex flex-col items-center justify-between gap-4 rounded-2xl border border-[#181B22] bg-[#0C1014]/50 p-4 backdrop-blur-[50px] sm:flex-row sm:items-center">
              ...
              <div className="flex w-full flex-col items-center justify-between gap-4 sm:w-auto sm:self-stretch">
                <div className="flex w-full items-center justify-center gap-4 sm:w-auto sm:justify-between">
