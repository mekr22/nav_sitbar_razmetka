...
const AnalystDetailLanding: FC = () => {
  ...
  const analyst = useMemo<ExtendedAnalyst>(() => {
    const fallback: ExtendedAnalyst = {
      ...
      description: "Hedge fund manager with extensive experience in technical and fundamental analysis. Specializes in cryptocurrency, forex, and stock markets with a proven track record.",
      originalDescription: "Hedge fund manager with extensive experience in technical and fundamental analysis. Specializes in cryptocurrency, forex, and stock markets with a proven track record.",
    };
  ...
  const hasOriginalDescription = Boolean(analyst.originalDescription && analyst.originalDescription.trim().length > 0);
  const descriptionToDisplay =
    showOriginalDescription && hasOriginalDescription
      ? analyst.originalDescription ?? ""
      : analyst.description ?? "";
    ...
    <div className="flex flex-col gap-6 max-[360px]:gap-4">
      ...
      <div className="mx-auto w-full max-w-[1075px] px-3 sm:px-4 max-[360px]:px-2">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:gap-6 max-[360px]:gap-4">
          <div className="flex flex-col gap-6 lg:flex-[2] lg:min-w-0 max-[360px]:gap-4">
            ...
            <div className="flex flex-col rounded-2xl border border-[#181B22] bg-[#0C1014]/50 backdrop-blur-[50px]">
              <div className="border-b border-[#181B22] p-4 max-[360px]:p-3">
                <h2 className="text-[19px] font-bold text-[#A06AFF] max-[360px]:text-base">About {analyst.name}</h2>
              </div>
            ...
            <div className="flex flex-col rounded-2xl border border-[#181B22] bg-[#0C1014]/50 backdrop-blur-[50px]">
              <div className="border-b border-[#181B22] p-4 max-[360px]:p-3">
                <h2 className="text-[19px] font-bold text-[#A06AFF] max-[360px]:text-base">Analysis Details</h2>
              </div>
              <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 max-[360px]:gap-3 max-[360px]:p-3">
              ...
              <div className="grid grid-cols-1 gap-4 border-t border-[#181B22] p-4 max-[360px]:gap-3 max-[360px]:p-3">
                <div className="flex flex-col gap-2 max-[360px]:gap-1.5">
                  <span className="text-xs font-bold uppercase text-[#B0B0B0]">Analysis Type</span>
                  <span className="text-[15px] font-bold text-white max-[360px]:text-sm">
                    {analyst.analysis}
                  </span>
                </div>
              ...
              <div className="grid grid-cols-1 gap-4 border-t border-[#181B22] p-4 sm:grid-cols-2 max-[360px]:gap-3 max-[360px]:p-3">
                <div className="flex flex-col gap-2 max-[360px]:gap-1.5">
                  <span className="text-xs font-bold uppercase text-[#B0B0B0]">Company</span>
                  <span className="text-[15px] font-bold text-white max-[360px]:text-sm">
                    {analyst.company}
                  </span>
                </div>
                <div className="flex flex-col gap-2 max-[360px]:gap-1.5">
                  <span className="text-xs font-bold uppercase text-[#B0B0B0]">Role</span>
                  <span className="text-[15px] font-bold text-white max-[360px]:text-sm">
                    {analyst.role}
                  </span>
                </div>
          ...
          {/* Right Sidebar - Analyst Card (Figma Design) */}
