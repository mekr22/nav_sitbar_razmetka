...
const InvestmentConsultantDetailLanding: FC = () => {
  ...
  const consultant = useMemo(() => {
    const fallback = {
      ...
      avatar:
        "https://cdn.builder.io/api/v1/image/assets/TEMP/6b81315108c0d5a4dad70aa8657893239c18b8db?width=624",
  ...
  const originalConsultantId = useMemo(
    () => extractOriginalProductId(consultant.id),
    [consultant.id],
  );
  const { isFavorite: isConsultantFavorite, toggle: toggleConsultantFavorite } =
    useFavorite("investment-consultant", originalConsultantId);
            ...
            <div className="flex flex-1 flex-col justify-between">
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[15px] font-bold text-white">
                  Dedicated to providing experienced guidance on all aspects of
                  wealth management
                </p>
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <div
                      key={badge}
                      className="flex items-center gap-1 rounded bg-[rgba(106,165,255,0.16)] px-1"
                    >
                      <span className="text-xs font-bold uppercase text-[#6AA5FF]">
                        {badge}
                      </span>
                    </div>
                  ))}
      ...
      <div className="mx-auto w-full max-w-[1075px] px-4">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <div className="flex flex-col gap-6 lg:flex-[2]">
            ...
            <div className="rounded-3xl border border-[#181B22] bg-[#0C1014]/50 p-4 backdrop-blur-[50px]">
              ...
              <p className="text-[15px] font-normal text-white">
                This algorithm is designed to optimize your trading decisions by
                analyzing market data in real time. It uses a combination of
                historical patterns and predictive models to identify
                high-probability entry and exit points. With a focus on risk
                management, the algorithm adjusts its strategy based on changing
                market conditions. Whether you're trading manually or using
                automated systems, this tool provides clear, actionable signals.
              </p>

              <h2 className="mb-4 mt-6 text-[19px] font-bold text-[#A06AFF]">
                Results and Cases:
              </h2>
              <div className="flex flex-col gap-2">
                {[
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-1 w-1 rounded-full bg-[#A06AFF]" />
                  <span className="text-[15px] font-normal text-white">
                    CFP<span className="font-bold">® Certification, 2011</span>
                  </span>
                </div>
              </div>
          ...
          <div className="flex w-full flex-col gap-6 lg:max-w-[339px]">
            {/* Video */}
            <div className="rounded-3xl border border-[#181B22] bg-[#0C1014]/50 p-4 backdrop-blur-[50px]">
              <h3 className="mb-4 text-[19px] font-bold text-[#A06AFF]">
                Video:
              </h3>
              ...
              <h3 className="mb-2 text-[19px] font-bold text-[#A06AFF]">
                Location:
              </h3>
              <p className="text-[15px] font-normal text-white">
                <span className="text-[#B0B0B0]">Main Office: </span>Tucson, AZ
                <br />
                <span className="text-[#B0B0B0]">Additional Locations: </span>
                Oro Valley, Marana, Vail
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-[#181B22] bg-[#0C1014]/50 backdrop-blur-[50px]">
              ...
              <div className="flex flex-wrap gap-2 p-4">
                {[
                  ...
                  <div
                    key={tag}
                    className="flex items-center gap-1 rounded bg-[#2E2744] px-1"
                  >
                    <span className="text-xs font-bold uppercase text-white">
                      {tag}
                    </span>
            ...
            <div className="rounded-3xl border border-[#181B22] bg-[#0C1014]/50 backdrop-blur-[50px]">
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex gap-0.5">
                      {[1, 2, 3, 4].map((star) => (
                        <Star
                          key={star}
                          className="h-4 w-4 fill-[#A06AFF] text-[#A06AFF]"
                        />
                      ))}
              ...
              <div className="flex flex-col">
                {[
                  ...
                  <div
                    key={idx}
                    className="border-b border-[#181B22] last:border-0"
                  >
