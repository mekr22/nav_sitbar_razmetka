...
export const baseInvestmentConsultants: InvestmentConsultant[] = [
  ...
  },
  {
    ...
    location: "Austin, TX",
    nationwide: false,
    description: "Navigating growth portfolios with a focus on sustainable returns",
    clients: "143",
    riskLevel: "Balanced",
    aum: "$3.1M",
    portfolioReturn: "+5.2%",
  },
  {
    ...
    location: "Seattle, WA",
    nationwide: true,
    description: "Legacy planning and wealth preservation for multigenerational families",
    clients: "165",
    riskLevel: "Conservative",
    aum: "$8.7M",
    portfolioReturn: "+3.1%",
